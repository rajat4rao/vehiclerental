const GraphCount= async(data,status)=>
{
    ...
    {
        var bookedstartdate=Number(data[i].start_date.split("-")[2]);
        var bookeddropdate=Number(data[i].drop_date.split("-")[2]);
        var bookedstartmonth=Number(data[i].start_date.split("-")[1]);
        var bookeddropmonth=Number(data[i].drop_date.split("-")[1])
        var bookedstartyear=Number(data[i].start_date.split("-")[0]);
        var bookeddropyear=Number(data[i].drop_date.split("-")[0]);
